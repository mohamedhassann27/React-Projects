...
const Header = () => {
    return (
        <section id='Home' className='min-h-screen overflow-x-hidden w-full bg-cover bg-center flex items-center justify-center text-white' style={{backgroundImage:headerImg}}>
            <Navbar/>
