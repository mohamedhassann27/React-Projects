...
function Navbar() {
  ...
  return (
    <header className="py-4 bg-white dark:bg-gray-800 max-lg:px-2 relative">
      <nav className="flex justify-between items-center max-w-7xl mx-auto px-2">
        <Link to={"/"}>
          <div className="flex gap-3 items-center text-xl dark:text-white">
            ...
            >
              ...
              />
              <path
                d="M3.62047 16.5128L0.647523 12.1802C0.310125 13.2984 0.127991 14.4849 0.127991 15.714C0.127991 20.1518 2.49618 24.0372 6.01474 26.1343L6.97732 21.5864C7.31377 19.9967 6.50618 18.3855 5.03109 17.7038C4.46232 17.441 3.975 17.0295 3.62047 16.5128Z"
                fill="#006C71"
              />
              <path
              ...
              />
              <path
                d="M13.4909 16.2519H10.5C9.76595 16.2519 9.17087 15.6567 9.17087 14.9228C9.17087 14.1888 9.76601 13.5936 10.5 13.5936H13.4909C14.225 13.5936 14.82 14.1888 14.82 14.9228C14.82 15.6567 14.225 16.2519 13.4909 16.2519Z"
                fill="#555559"
                fillOpacity="0.4"
              />
              <path
        ...
        <div className="flex gap-5">
            ...
            <div className="bg-black px-2 py-1 rounded-full flex items-center gap-2 h-9">
            <IoIosSunny
                className="text-2xl bg-white dark:bg-transparent rounded-full text-black dark:text-white p-1"
                onClick={() => toggleTheme("light")}
            />
            <FaMoon
                className=" text-2xl rounded-full text-white dark:bg-white dark:text-black p-1"
                onClick={() => {
                toggleTheme("dark");
                }}
            />
